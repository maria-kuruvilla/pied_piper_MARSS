#Goal - do one more trial
#have both day and night values for puyallup coho
#but only start from doy 115
...
fit.model_check = c(list(c= c), mod_list(num_rows,5,1, FALSE, FALSE))
