...
We collected temperature data for years 2005-2013 from the Washington Department of Ecology website. For the years 2014-2020, we used temperature data collected by a logger near the trap. However, data from 2015 was missing.
...
We calculated accumulated thermal units as the cumulative sum of the temperature experienced since Winter Solstice.
